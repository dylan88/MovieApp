 ...
 */
final class Version20220331143412 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, username, age FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, username VARCHAR(64) NOT NULL, age SMALLINT NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, username, age) SELECT id, email, roles, password, username, age FROM __temp__user');
